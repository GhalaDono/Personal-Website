<div
        class="mt-20 w-[300px] h-[420px] bg-transparent cursor-pointer group perspective"
      >
        <div
          class="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000"
        >
          <div class="absolute backface-hidden border-8 w-full h-full" style="border-color: #A3BFFA;">
            <img src="./pic/Calculator.png" class="w-full h-full" />
          </div>
          <div
          ...
          >
            ...
            >
              ...
              <button
                class=" bg-[#a3bffa] px-6 py-2 font-semibold text-white rounded-full absolute translate-y-7 -bottom-20 delay-500 duration-1000 group-hover:bottom-20 scale-0 group-hover:scale-125"
              >
                Watch Now
              </button>
            </div>
